...
class TextHelperTest < ActionView::TestCase
  ...
  def test_excerpt
    ...
    assert_equal('...is a beautiful? mor...', excerpt('This is a beautiful? morning', /\bbeau\w*\b/iu, :radius => 5))
    assert_equal('...is a beautiful? mor...', excerpt('This is a beautiful? morning', /\b(beau\w*)\b/iu, :radius => 5))
    ...
    assert_equal("...was challenging for...", excerpt("This day was challenging for judge Allen and his colleagues.", /\b(\w*allen\w*)\b/iu, :radius => 5))
